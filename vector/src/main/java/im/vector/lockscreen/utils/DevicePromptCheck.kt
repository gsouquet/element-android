 ...
 * The device lists are taken from [this repository](https://github.com/sergeykomlach/AdvancedBiometricPromptCompat/blob/main/biometric/src/main/java/dev/skomlach/biometric/compat/utils/DevicesWithKnownBugs.kt).
 */
